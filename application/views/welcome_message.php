                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="header-hero-content">
                            <h1 class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><span>US Dollar</span> to <b>Indian Rupee Conversion</b></h1>
                            <p class="text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">use USD-INR to convert US Dollar to Indian Rupee</p>
                            <div class="header-singup wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s" style="margin-top: 20px">
                                <input type="text" class="onlydecimal" placeholder="Enter Amount Here" onkeyup="getamountininr(this.value);">
                                <button class="main-btn"><i class="fa fa-angle-right" style="font-size: 55px;"></i></button>
                            </div>
                            <br>
                            <h1 align="center" style="font-size: 30px;" class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><span ><usd>1</usd> USD =</span><br> <b><inr style="font-size: 60px;">76.5017</inr>&nbsp;INR</b></h1>
